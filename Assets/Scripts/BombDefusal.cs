...
public class BombDefusal : MonoBehaviour
{
    ...
    void Start()
    {
        GameManager.instance.AddMissionObjective("Locate and Defuse the bomb before time runs out!");
    }
    ...
    public void DefuseBomb()
    {
       // Debug.Log("Bomb has been defused!");
        //Destroy(gameObject);
        GameManager.instance.CompleteMissionObjective("Locate and Defuse the bomb before time runs out!");
    }
